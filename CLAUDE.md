...
### Phase E — Launch
26. Custom domain (getvela.ai or similar)
27. E-commerce website type (future — dropped from active Design Engine scope, see §12)
28. Voice notes in training (future — audio recording + transcription)
29. Video for landing page (Screen Studio or Remotion — after product is stable)
