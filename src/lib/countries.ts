...
/** Compute Unicode flag emoji from ISO 3166-1 alpha-2 code */
export function countryFlag(iso2: string): string {
  return iso2.toUpperCase().split("").map((c) => String.fromCodePoint(0x1f1a5 + c.charCodeAt(0))).join("");
}
...
export const COUNTRIES: Country[] = [
  ...
  { name: "Bosnia & Herzegovina", iso2: "BA", dial: "+387" },
...
export const DEFAULT_COUNTRY = COUNTRIES.find((c) => c.iso2 === "AE")!;

/** Detect country from browser navigator.language (best effort, fallback to UAE) */
export function detectDefaultCountry(): Country {
  if (typeof navigator === "undefined") return DEFAULT_COUNTRY;
  const lang = navigator.language || "";
  // "en-US" → "US", "ar-AE" → "AE", "fr-FR" → "FR"
