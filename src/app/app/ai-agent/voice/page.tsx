    ...
    <div className="flex-1 p-6 md:p-8" style={{ background: bg }}>
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-sm" style={{ color: textMuted }}>Choose how your AI Agent sounds to you during calls.</p>
        </div>
        ...
        <div className="rounded-2xl border p-6" style={{ background: cardBg, borderColor: border }}>
          ...
          <p className="text-xs mt-3" style={{ color: textMuted }}>
            {speed < 0.8 ? "Very slow — great for complex topics" :
             speed < 0.95 ? "Slightly slower — authoritative and clear" :
             speed <= 1.05 ? "Natural speed" :
             speed < 1.2 ? "Slightly faster — energetic" :
             "Fast — efficient conversations"}
          </p>
        </div>
