...
function PaletteIcon({ type }: { type: string }) {
  ...
  if (type === "brain") return <svg width="15" height="15" viewBox="0 0 15 15" fill="none" className={cls}><circle cx="7.5" cy="6.5" r="4" stroke="currentColor" strokeWidth="1.3"/><path d="M5.5 6.5a2 2 0 014 0" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/><circle cx="7.5" cy="6.5" r="1" fill="currentColor"/><path d="M5.5 10.5l1-1M9.5 10.5l-1-1M7.5 9.5v2M5 12h5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>;
