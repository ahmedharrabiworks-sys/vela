          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="relative hidden sm:block">
              <input
                ...
                className="pl-9 pr-4 py-2 text-sm bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl w-56 lg:w-64 text-[#111827] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#FF6B35]/40 transition-colors"
              />
