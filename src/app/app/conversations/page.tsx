...
export default function ConversationsPage() {
  ...
  return (
    <div className="h-full flex gap-5 max-w-7xl mx-auto">
      {/* Left — list */}
      <div className="w-80 flex flex-col bg-white rounded-2xl border border-[#f0e8e0] shadow-card overflow-hidden">
      ...
      {/* Right — thread */}
      <div className="flex-1 flex flex-col bg-white rounded-2xl border border-[#f0e8e0] shadow-card overflow-hidden">
        {/* Thread header */}
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#f0e8e0]">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="text-xs font-semibold px-3 py-1.5 rounded-lg border border-[#f0e8e0] text-[#888888] hover:border-[#FF6B35] hover:text-[#FF6B35] transition-all">
              Human Takeover
            </button>
